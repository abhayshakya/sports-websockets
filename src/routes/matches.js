...
matchRouter.get('/', async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ error: 'Failed to list matches.', details: err instanceof Error ? err.message : String(err) });
    }
});
...
matchRouter.post('/', async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ error: 'Failed to create match.', details: err instanceof Error ? err.message : String(err) });
    }
});